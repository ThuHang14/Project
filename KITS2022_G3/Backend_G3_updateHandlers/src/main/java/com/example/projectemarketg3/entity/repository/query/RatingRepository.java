package com.example.projectemarketg3.entity.repository.query;
...
//    @Query("select new com.example.projectemarketg3.dto.request.other.RatingDto(r.createAt,r.note,r.image,r.star,r.checking,r.user.id,r.product.id) " +
